...
void GeoAreaFacV2(
  ...
  TH2F *hDxDyDz = SetTDDDModel("hDxDyDz",Form("G.A. of binWidth = %.4f",binWidth),binWidth);
...
void GeoAreaFacV3( const int iProc, const int iCore, const char OPT='N' ){
  ...
  TH2F *hDxDyDz = SetTDDDModel(Form("hDxDyDz%d",iProc),Form("G.A. of binWidth = %.4f",binWidth),binWidth);
