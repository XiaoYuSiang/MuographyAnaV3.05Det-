...
TH2F *SetTDDDModel(
  ...
  double RangeBin[2] = {0};
  int    NumBins = 0;
  GetFluxRangeOddBinNum(FluxBinDXYDZRange,binWidth,RangeBin[0],RangeBin[1],NumBins,true);
  int binNFX = NumBins, binNFY = NumBins;
  
  TH2F *TDDDM = new TH2F(Name,Title,binNFX,RangeBin[0],RangeBin[1],binNFY,RangeBin[0],RangeBin[1]);
  //TDDDM->SetStats(0);
...
void FitTrackResAnaV2(
  ...
  double RangeBin[2] = {0};
  int    NumBins = 0;
  GetFluxRangeOddBinNum(FluxBinDXYDZRange,binWidth,RangeBin[0],RangeBin[1],NumBins);
  int binNFX = NumBins, binNFY = NumBins;
