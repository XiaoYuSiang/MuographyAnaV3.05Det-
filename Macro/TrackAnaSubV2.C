...
void TrackAnaSubV2(const string InputGapTFile, const string Tmp_ETrFile_hash, const string evhash, const string OsName, const int ir, const int ev_Fir, const int ev_Fin,const double trigger) {
  // cout<<"44- ir = "<<ir<<endl;
  // return;
  char version[8] = {};
